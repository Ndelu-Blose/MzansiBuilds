      ...
      <div data-testid="celebration-page">
        ...
        >
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h1 className="text-4xl sm:text-5xl font-black text-foreground tracking-tighter mb-4">Celebration Wall</h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
          {projects.length === 0 ? (
            <div className="bg-card border border-border rounded-xl shadow-card p-12 text-center max-w-lg mx-auto">
              ...
              <p className="text-muted-foreground">Be the first to complete a project and join the celebration!</p>
            </div>
          ) : (
            <>
